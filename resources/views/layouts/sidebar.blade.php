...
<div class="float-left col-1 pl-0 pr-0 collapse width show" id="sidebar">
        ...
        <a href="/laboratorios" class="list-group-item d-inline-block collapsed" data-parent="#sidebar"><i class="fa fa-desktop"></i> <span class="d-none d-md-inline">Laboratorios</span></a>
    </div>
</div>

{{-- <div class="sidenav">
   <a class="nav-link" href="/items/create">Registrar item</a>
